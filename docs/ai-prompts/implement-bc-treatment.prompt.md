...
- docs/domain-foundation/planificació/pas-a-pas/07 - Treatment BC (relació clínica activa).md
- docs/domain-foundation/bounded-contexts/treatment.md
- docs/domain-foundation/bounded-contexts/treatment - 2.md
