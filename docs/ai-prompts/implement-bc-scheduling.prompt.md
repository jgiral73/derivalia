...
- docs/domain-foundation/planificació/pas-a-pas/06 - Scheduling & Agenda (MVP amb enforcement real).md
- docs/domain-foundation/bounded-contexts/scheduling.md
- docs/domain-foundation/bounded-contexts/scheduling - Rescheduling & No-Show Policies.md
- docs/domain-foundation/bounded-contexts/scheduling - Sincronització amb calendaris externs.md
- docs/domain-foundation/bounded-contexts/scheduling avan‡at.md
