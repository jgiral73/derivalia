...
- docs/reference/domain-foundation/planificació/pas-a-pas/08 - Collaboration BC (col·laboració professional–professional).md
- docs/reference/domain-foundation/bounded-contexts/collaboration - Professional Collaboration (co-atenció clínica).md
